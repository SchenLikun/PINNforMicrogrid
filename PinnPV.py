...
class PID():
    ...
    def train(self):
        ...
        checker= dde.callbacks.ModelCheckpoint('save_model/model' + str(self.index) + '.ckpt', save_better_only = True, period = 20000)
...
if __name__ == "__main__":
    ...
    microgird.build(transform='all',
                    ...
                    lr=1e-3,
                    iterations=3000000)
    microgird.model.restore("save_model/modelNone.ckpt-3000.pt", verbose=1)
    microgird.train()
